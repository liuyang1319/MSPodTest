...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/liuyang1319/MSPodTest'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'liuyang' => 'yang.liu-g@msxf.com' }
  s.source           = { :git => 'https://github.com/liuyang1319/MSPodTest.git', :tag => s.version.to_s }
